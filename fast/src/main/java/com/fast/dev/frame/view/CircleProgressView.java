...
public class CircleProgressView extends View{
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.FastDevFrameCircleProgressBar,defStyleAttr,0);
        mBorderWidth = array.getDimension(R.styleable.FastDevFrameCircleProgressBar_FastDevFrameborder, 4.0f);
        angleAnimatorDuration = array.getInt(R.styleable.FastDevFrameCircleProgressBar_FastDevFrameangleAnimationDurationMillis, 2000);
        sweepAnimatorDuration = array.getInt(R.styleable.FastDevFrameCircleProgressBar_FastDevFramesweepAnimationDurationMillis, 900);
        minSweepAngle = array.getInt(R.styleable.FastDevFrameCircleProgressBar_FastDevFrameminSweepAngle,30);
        int colorArrayId = array.getResourceId(R.styleable.FastDevFrameCircleProgressBar_FastDevFramecolorSequence,R.array.FastDevFrame_circle_default_color_sequence);
        if (isInEditMode()){
            mColors = new int[4];
            mColors[0] = getResources().getColor(R.color.FastDevFrame_circular_blue,null);
            mColors[1] = getResources().getColor(R.color.FastDevFrame_circular_green,null);
            mColors[2] = getResources().getColor(R.color.FastDevFrame_circular_red,null);
            mColors[3] = getResources().getColor(R.color.FastDevFrame_circular_yellow,null);
        }else {
