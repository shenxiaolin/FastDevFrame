...
import com.fast.dev.frame.database.CursorHelper;
import com.fast.dev.frame.database.DaoConfig;
import com.fast.dev.frame.database.OneToManyLazyLoader;
import com.fast.dev.frame.database.DbModel;
import com.fast.dev.frame.database.SqlBuilder;
import com.fast.dev.frame.database.SqlInfo;
import com.fast.dev.frame.database.utils.KeyValue;
import com.fast.dev.frame.database.utils.ManyToOne;
import com.fast.dev.frame.database.utils.OneToMany;
import com.fast.dev.frame.database.utils.TableInfo;
...
public class DBUtils {
     ...
     * 创建DBLibrary
     */
    public static DBUtils create(String dbname) {
     ...
     */
    public static DBUtils create(String dbname,boolean isDebug) {
        return create(ActivityStack.create().topActivity(), dbname,isDebug);
    }
    ...
    public static DBUtils create(Context context, String dbName) {
        return create(context,dbName,false);
    }
     ...
     *            数据库名称
     */
    public static DBUtils create(Context context, String targetDirectory,
                              String dbName) {
        DaoConfig config = new DaoConfig();
        config.setContext(context);
        config.setDbName(dbName);
    ...
    private void exeSqlInfo(SqlInfo sqlInfo) {
        if (sqlInfo != null) {
            ...
            LogUtils.v(getClass().getName() + "sava error:sqlInfo is null");
        }
    }
