...
import com.fast.dev.frame.utils.ColorUtils;
...
public class SwitchButton extends CompoundButton{
    ...
    private Drawable mThumbDrawable,mBackDrawable,mCurrentBackDrawable,mNextBackDrawable;
    private ColorStateList mBackColor,mThumbColor;
    private boolean mDrawDebugRect = false;

    private boolean mIsThumbUseDrawable,mIsBackUseDrawable,mFadeBack;

    private int mTintColor,mCurrThumbColor,mCurrBackColor,mNextBackColor;
    private float mBackMeasureRatio,mThumbRadius,mBackRadius;
    ...
    private void init(AttributeSet attrs){
        ...
        mRectPaint.setStrokeWidth(density);
        ...
        TypedArray array = attrs == null? null:getContext().obtainStyledAttributes(attrs, R.styleable.SwitchButton);
        if (array != null){
            thumbColor = array.getColorStateList(R.styleable.SwitchButton_thumbColor);
            margin = array.getDimension(R.styleable.SwitchButton_thumbMargin, margin);
            marginLeft = array.getDimension(R.styleable.SwitchButton_thumbMarginLeft, marginLeft);
            marginRight = array.getDimension(R.styleable.SwitchButton_thumbMarginRight, marginRight);
            marginTop = array.getDimension(R.styleable.SwitchButton_thumbMarginTop, marginTop);
            marginBottom = array.getDimension(R.styleable.SwitchButton_thumbMarginBottom, marginBottom);
            thumbWidth = array.getDimension(R.styleable.SwitchButton_thumbWidth, thumbWidth);
            thumbHeight = array.getDimension(R.styleable.SwitchButton_thumbHeight, thumbHeight);
            thumbRadius = array.getDimension(R.styleable.SwitchButton_thumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
            backRadius = array.getDimension(R.styleable.SwitchButton_backRadius, thumbRadius + density * 2f);
            backDrawable = array.getDrawable(R.styleable.SwitchButton_backDrawable);
            backColor = array.getColorStateList(R.styleable.SwitchButton_backColor);
            backMeasureRatio = array.getFloat(R.styleable.SwitchButton_backMeasureRatio, backMeasureRatio);
            animationDuration = array.getInteger(R.styleable.SwitchButton_animationDuration, animationDuration);
            fadeBack = array.getBoolean(R.styleable.SwitchButton_fadeBack, true);
            tintColor = array.getColor(R.styleable.SwitchButton_tintColor, tintColor);
            array.recycle();
        }
