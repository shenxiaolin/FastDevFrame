...
import com.fast.dev.frame.database.ManyToOneLazyLoader;
import com.fast.dev.frame.database.annotate.Table;
...
public class ClassUtils {
    ...
    public static String getPrimaryKeyColumn(Class<?> clazz) {
        ...
        if (fields != null) {
            com.fast.dev.frame.database.annotate.ID idAnnotation = null;
            Field idField = null;

            for (Field field : fields) { // 获取ID注解
                idAnnotation = field.getAnnotation(com.fast.dev.frame.database.annotate.ID.class);
    ...
    public static Field getPrimaryKeyField(Class<?> clazz) {
        ...
        if (fields != null) {
            ...
            for (Field field : fields) { // 获取ID注解
                if (field.getAnnotation(com.fast.dev.frame.database.annotate.ID.class) != null) {
