...
import com.fast.dev.frame.database.annotate.ManyToOne;
import com.fast.dev.frame.database.annotate.OneToMany;
import com.fast.dev.frame.database.annotate.Property;
import com.fast.dev.frame.database.annotate.Transient;
...
public class FieldUtils {
    ...
    public static Field getFieldByColumnName(Class<?> clazz, String columnName) {
        ...
        if (columnName != null) {
            ...
            if (fields != null && fields.length > 0) {
                ...
                if (field == null) {
                    for (Field f : fields) {
                        com.fast.dev.frame.database.annotate.Property property = f.getAnnotation(com.fast.dev.frame.database.annotate.Property.class);
                        if (property != null
                        ...
                        com.fast.dev.frame.database.annotate.ManyToOne manyToOne = f.getAnnotation(com.fast.dev.frame.database.annotate.ManyToOne.class);
                        if (manyToOne != null
    ...
    public static String getColumnByField(Field field) {
        com.fast.dev.frame.database.annotate.Property property = field.getAnnotation(com.fast.dev.frame.database.annotate.Property.class);
        if (property != null && property.column().trim().length() != 0) {
            return property.column();
        }

        com.fast.dev.frame.database.annotate.ManyToOne manyToOne = field.getAnnotation(com.fast.dev.frame.database.annotate.ManyToOne.class);
        if (manyToOne != null && manyToOne.column().trim().length() != 0) {
            return manyToOne.column();
        }

        com.fast.dev.frame.database.annotate.OneToMany oneToMany = field.getAnnotation(com.fast.dev.frame.database.annotate.OneToMany.class);
        if (oneToMany != null && oneToMany.manyColumn() != null
                && oneToMany.manyColumn().trim().length() != 0) {
            return oneToMany.manyColumn();
        }

        com.fast.dev.frame.database.annotate.ID id = field.getAnnotation(com.fast.dev.frame.database.annotate.ID.class);
    ...
    public static String getPropertyDefaultValue(Field field) {
        com.fast.dev.frame.database.annotate.Property property = field.getAnnotation(Property.class);
